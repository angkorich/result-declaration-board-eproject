				...
				<form action="../ControllExamMark"  method="post"  name="form1" class="form" id="form1" onsubmit="return kiemtra()" >
						...
						<div class="float-left gutter-right">
                                ...
                                <option selected="selected" value="${u.username}">${u.username}</option>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="ExamTimes" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="Marks" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td> 
                                                        ...
                                                        <span class="input-type-text"><input type="text" id="datepicker" name="txtdateexam" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
