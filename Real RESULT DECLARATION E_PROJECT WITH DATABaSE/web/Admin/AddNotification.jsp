<%-- 
    ...
    Created on : May 2, 2013, 6:36:54 PM
    Author     : Shiv
--%>
					...
					<li ><a href="indexAdmin2.jsp?page=Admin&url=Schedules" title="Schedules Lists">Schedules Lists</a></li>
                        ...
                        <ul>
                         ...
                         <ul>
                             ...
                             <li class="current"><a href="indexAdmin2.jsp?page=Admin&url=AddNotification" title="AddNotification">Add Notification  </a></li>
                            </ul> 
     ...
     <div id="sub-nav"><div class="container_12">
        ...
        <section class="grid_8">
			<div class="block-border"><div class="block-content">
				...
				<%
         String nd=""; String nt=""; String ni=""; String no=""; 
        if(session.getAttribute("nd")!=null){
            nd=session.getAttribute("nd").toString();
            nt=session.getAttribute("nt").toString();
            ni=session.getAttribute("ni").toString();
            no=session.getAttribute("nod").toString();
				...
				<form action="../ControllNotification"  method="post"  name="form1" class="form" id="form1" onsubmit="return kiemtra()" >
					...
					<fieldset class="grey-bg">
						...
						<div class="float-left gutter-right">
                                                    ...
                                                    <td><input type="text" name="txtnoid" id="stats-period" value="" /></td>
                                                    <input type="hidden" name="txttemp" value="<%=nd%>" />
                                                   ...
                                                   <div class="float-left">
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtnotitle" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtnoinfo" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" id="datepicker4" name="txtnodate" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
