    ...
    <body>
		...
		<ul class="container_12"  >
			...
			<li class="medias current"><a href="indexAdmin2.jsp?page=Admin&url=ExamMark" title="Exam Marks Manage">Marks</a>
				<ul>
                                    ...
                                    <li class="current" ><a href="indexAdmin2.jsp?page=Admin&url=ExamMark" title="Exam Marks Lists">Exam Marks Lists</a></li>
     ...
     <div id="sub-nav"><div class="container_12">
        ...
        %>
          ...
          <%
            BranchBean ojb3=new BranchBean();
            Collection kq2=ojb3.getAllbranchlist();
            request.setAttribute("st2", kq2);
            %>
        
         <%
            UserBean ojb4=new UserBean();
            Collection mp=ojb4.getAlllist();
            request.setAttribute("st2", mp);
            %>
			...
			<div class="block-border"><form class="block-content form" name="formSuser" id="formSuser" method="get" action="Searchexammark">
				...
				<div class="block-controls">
					...
					<button type="submit" name="bt" value="Rollno Marks" ><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Search Marks obtain >40 </button>
				</div>
						...
						<tr>
							...
							<td><ul class="keywords">
								<li><a href="#">${s.subid}</a></li>
                                                        ...
                                                        <td><ul class="keywords">
								<li class="purple-keyword"><a href="#">${s.semid}</a></li>
                                                        ...
                                                        <td><ul class="keywords">
								<li class="green-keyword"><a href="#">${s.curid}</a></li>
								
							</ul></td>
                                                        
                                                        
                                                         <td><ul class="keywords">
								<li ><a href="#">${s.branchid}</a></li>
								
							</ul></td>
                                                        
                                                        
                                                        <td><ul class="keywords">
								<li class="orange-keyword"><a href="#">${s.username}</a></li>
							 ...
							 <td><ul class="keywords"><li class="purple-keyword">${s.mark}</li></ul></td>
                                    ...
                                    <c:param name="sid" value="${s.semid}" />
                                     <c:param name="cid" value="${s.curid}" />
                                     <c:param name="bid" value="${s.branchid}" />
                                     <c:param name="usen" value="${s.username}" />
