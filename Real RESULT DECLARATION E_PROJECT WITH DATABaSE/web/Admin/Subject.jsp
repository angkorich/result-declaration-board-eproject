		...
		<ul class="container_12"  >
			...
			<li class="comments current "><a href="indexAdmin2.jsp?page=Admin&url=Subject" title="Subjects Manage">Subjects</a>
				<ul>
                                    ...
                                    <li class="current" ><a href="indexAdmin2.jsp?page=Admin&url=Subject" title="Lists Of Subjects"> Lists Of Subjects</a></li>
		...
		<section class="grid_12">
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
				...
				<div class="no-margin">
                    ...
                    <pg:paging pageSize="5" url="indexAdmin2.jsp?page=Admin&url=Subject"> 
                       <c:forEach items="${st}" var="s">
						...
						<tr>
                                                    ...
                                                    <td scope="row" class="table-check-cell "> <ul class="keywords"><li class="orange-keyword"><c:out value="${s.subID}" /></li> </ul> </td>
							
							<td><ul class="keywords">
								<li><a href="#">${s.semID}</a></li>
								
							</ul></td>
                                                        <td><ul class="keywords"><li class="purple-keyword">${s.subName}</li></ul></td>
                                                       
							
                                                        
                                                         <c:url var="edit" value="../ControllSubject">
                                        <c:param name="bt" value="Edit" />
                                         <c:param name="subid" value="${s.subID}" />
                                         <c:param name="subName" value="${s.subName}" />
                                        
                                        <c:param name="p" value="${param.pageNum}"/> 
                                    </c:url> 
                                                        <c:url var="delete" value="../ControllSubject">
