<%-- 
    Document   : UpdateExamMark
    Created on : Apr 25, 2013, 3:56:43 PM
    Author     : Shiv
--%>
    ...
    <body>
     ...
     <div id="sub-nav"><div class="container_12">
        ...
        if(session.getAttribute("exameID")!=null){
            ...
            sem=session.getAttribute("subject").toString();
						...
						<legend><a href="#">Options</a></legend>
                                                <table>
                                                  ...
                                                  <div class="float-left">
                                                    ...
                                                    <tr>
                                                    <td><label for="stats-period">Exam ID</label></td>
                                                    <td><ul class="keywords"><li class=" purple-keyword"><%=r%></li></ul></td>
                        ...
                        %>--%>
                              ...
                              <%--   <% if(drop.equals(subj.subID)){%>
                                ...
                                <option selected="selected" value="${u.username}">${u.username}</option>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="ExamTimes" id="stats-period" value="<%=m%>"></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="Marks" id="stats-period" value="<%=ma%>"></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td> 
                                                        ...
                                                        <span class="input-type-text"><input type="text" id="datepicker" name="txtdateexam" id="stats-period" value="<%=d%>"></span></td>
                                                    </tr>
						</div>
